...
public class PatchRegistry {
	...
	public static final RegistryObject<Block> DANDELION_PATCH = register("dandelion_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.SATURATION, 7, () -> Blocks.DANDELION, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.DANDELION).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> POPPY_PATCH = register("poppy_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.NIGHT_VISION, 5, () -> Blocks.POPPY, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.POPPY).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> BLUE_ORCHID_PATCH = register("blue_orchid_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.SATURATION, 7, () -> Blocks.BLUE_ORCHID, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_ORCHID).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> ALLIUM_PATCH = register("allium_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.FIRE_RESISTANCE, 4, () -> Blocks.ALLIUM, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.ALLIUM).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> AZURE_BLUET_PATCH = register("azure_bluet_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.BLINDNESS, 8, () -> Blocks.AZURE_BLUET, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.AZURE_BLUET).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> RED_TULIP_PATCH = register("red_tulip_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.WEAKNESS, 9, () -> Blocks.RED_TULIP, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.RED_TULIP).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> ORANGE_TULIP_PATCH = register("orange_tulip_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.WEAKNESS, 9, () -> Blocks.ORANGE_TULIP, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_TULIP).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> WHITE_TULIP_PATCH = register("white_tulip_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.WEAKNESS, 9, () -> Blocks.WHITE_TULIP, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_TULIP).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> PINK_TULIP_PATCH = register("pink_tulip_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.WEAKNESS, 9, () -> Blocks.PINK_TULIP, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_TULIP).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	...
	public static final RegistryObject<Block> LILY_OF_THE_VALLEY_PATCH = register("lily_of_the_valley_patch", (properties) ->
			new FlowerPatchBlock(MobEffects.POISON, 12, () -> Blocks.LILY_OF_THE_VALLEY, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.LILY_OF_THE_VALLEY).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));
	public static final RegistryObject<Block> TORCHFLOWER = register("torchflower", (properties) ->
			new FlowerPatchBlock(MobEffects.NIGHT_VISION, 5, () -> Blocks.TORCHFLOWER, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.TORCHFLOWER).noCollission().instabreak().sound(SoundType.GRASS).offsetType(BlockBehaviour.OffsetType.XZ));

	public static final RegistryObject<Block> BROWN_MUSHROOM_PATCH = register("brown_mushroom_patch", (properties) ->
			new MushroomPatchBlock(() -> Blocks.BROWN_MUSHROOM, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_MUSHROOM).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).lightLevel((state) -> 1).hasPostProcess((state, getter, pos) -> true));
	public static final RegistryObject<Block> RED_MUSHROOM_PATCH = register("red_mushroom_patch", (properties) ->
			new MushroomPatchBlock(() -> Blocks.RED_MUSHROOM, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM).noCollission().randomTicks().instabreak().sound(SoundType.GRASS).hasPostProcess((state, getter, pos) -> true));
